...
class _HomeScreenState extends State<HomeScreen> {
  ...
  /// Main View for Breath Management Tab - "메인화면_호흡관리화면"
  Widget _buildBreathView() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Top App Header: Logo + Notification Bell + Profile Avatar
        _buildBreathHeader(),
        const SizedBox(height: 24),

        // Greeting Section: "안녕하세요, GUEST님" / "오늘의 호흡 상태를 분석했어요"
        _buildBreathGreetingSection(),
        ...
        // Card 2: 스트레스 지수 / Stress Index Card (Soft Pastel Yellow/Lime)
        _buildStressCard(),
        const SizedBox(height: 28),

        // Section 1: 오늘의 추천 호흡
        _buildRecommendedBreathSection(),
        const SizedBox(height: 28),

        // Section 2: 호흡하기 (Breathing List Cards)
        _buildBreathingListSection(),
        const SizedBox(height: 24),
  ...
  /// Top App Header with Profile Avatar Image
  Widget _buildBreathHeader() {
    return Row(
  ...
  /// Greeting Text Section: "안녕하세요, GUEST님" / "오늘의 호흡 상태를 분석했어요"
  Widget _buildBreathGreetingSection() {
    return const Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              // Right: Polyline Line Chart with Glowing Circular Dots
              SizedBox(
                width: 140,
                height: 45,
                child: CustomPaint(
                  painter: _HrvLineChartPainter(
                    points: const [0.35, 0.65, 0.3, 0.6, 0.4, 0.62, 0.55, 0.8, 0.7, 0.72],
                  ),
                ),
              ),
            ],
  ...
  Widget _buildStressCard() {
    ...
    return Container(
      ...
      padding: const EdgeInsets.all(20),
      decoration: BoxDecoration(
        color: const Color(0xFFEFF8A8), // Light Soft Yellow/Lime matching Figma images
        borderRadius: BorderRadius.circular(20),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  /// Section 1: 오늘의 추천 호흡
  Widget _buildRecommendedBreathSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const Text(
  ...
  /// Section 2: 호흡하기 (Breathing List Cards)
  Widget _buildBreathingListSection() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        // Section Header Row
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => const RecommendedBreathingScreen(),
                  ),
                );
              },
              child: const Padding(
        ...
        _buildBreathListItemCard(
          ...
          boxColor: const Color(0xFF344265),
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => const RecommendedBreathingScreen(),
        ...
        _buildBreathListItemCard(
          ...
          description: '숙면과 스트레스 완화에 도움을 줘요',
          boxColor: const Color(0xFF47385E),
          onTap: () {
            Navigator.of(context).push(
              MaterialPageRoute(
                builder: (context) => const RecommendedBreathingScreen(),
  ...
  /// Single Item Card inside "호흡하기" section
  Widget _buildBreathListItemCard({
    required String title,
    required String durationAndDifficulty,
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 11.5,
                    fontWeight: FontWeight.w400,
                    color: AppColors.lightGray.withAlpha(204),
                  ),
                  maxLines: 1,
